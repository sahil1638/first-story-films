-- Migration: 049_optimize_cleanup_rpc.sql
-- Redefines cleanup_test_data RPC to only delete records associated with the specific test_run_id.
-- This ensures parallel test runs do not delete each other's active test data.
